...
public class TabUI extends BasicTabbedPaneUI {
	...
	public TabUI() {
		...
		selectedColorSet.topGradColor1 = new Color(248, 218, 110);
		selectedColorSet.topGradColor2 = new Color(240, 196, 64);
		selectedColorSet.bottomGradColor1 = new Color(239, 165, 29);
		selectedColorSet.bottomGradColor2 = new Color(253, 226, 77);
